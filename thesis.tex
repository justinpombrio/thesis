...
% Expressions
\newcommand{\Con}[2]{(\Variable{u}{}{C}{}\,#2)}
\newcommand{\Core}[2]{(\Variable{u}{}{C}{core}\,#2)}
\newcommand{\Aux}[2]{(\Variable{u}{}{C}{aux}\,#2)}
\newcommand{\Surf}[2]{(\Variable{u}{}{C}{surf}\,#2)}
...
\include{chapters/desugaring-for-pyret}
\part{Resugaring}
