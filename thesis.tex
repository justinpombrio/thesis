...
\newcommand{\SaysExp}[3]{#1 \vdash #2 \rightsquigarrow_\text{ds} #3}
\newcommand{\SaysExps}[3]{#1 \vdash #2 \rightsquigarrow^{*}_\text{ds} #3}
\newcommand{\SaysCase}[4]{#1;#4 \vdash #2 \rightsquigarrow_\text{exp} #3}
\newcommand{\SaysUnexp}[3]{#1 \vdash #2 \rightsquigarrow_\text{rs} #3}
\newcommand{\SaysUnexps}[3]{#1 \vdash #2 \rightsquigarrow^{*}_\text{rs} #3}
\newcommand{\SaysUncase}[4]{#1;#4 \vdash #2 \rightsquigarrow_\text{unexp} #3}
...
\include{chapters/desugaring-systems}
