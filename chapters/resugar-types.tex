...
programmer as suggested changes. This approach could work just as well
in the presence of syntactic sugar (as long as the search for program
modifications can be done over the surface language) and so this
could be an alternative source of feedback in such cases.
