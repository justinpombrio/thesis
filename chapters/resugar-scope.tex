...
scope inference will be agnostic to the difference between
\Sc{surf}, \Sc{core}, and \Sc{aux} constructors, so we omit the
distinction:
...
\emph{pattern variables} $\PVar_i$ in them).\footnote{
  ...
  perspective of the TRS. [TODO: if support ellipses, remove]}
\marginpar{For now, we will admit \emph{unhygienic} sugars; hygiene will be
...
to be translated to match our fixed-arity assumption.
[TODO: remove assumption] (To do so, we
