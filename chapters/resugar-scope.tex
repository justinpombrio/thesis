...
\begin{proof}[Proof sketch]
  ...
  arguments $a_1, \dd, a_n$, and for all permuations of variable names
  $\sigma$, $\phi(a_1, \dd, a_n) \text{ iff } \phi(\sigma(a_1), \dd,
  \sigma(a_n))$.  The only parts of $\alpha$-equivalence
...
\begin{proof}[Proof sketch]
  ...
  resugaring in \cref{sec:formal-reqs}, and properties
  (1)--(3) in this section. We must show that both sets of
  requirements hold both forward and in reverse:
  \subsubsection{Assumptions about desugaring (\cref{sec:formal-reqs})}
