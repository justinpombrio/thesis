...
[TODO: need 4 args, or just the three?]
...
\Inference[scope-e-con]{
  ...
  \SaysScope{\Sigma}{\Core{C}{e_1 ... e_n}}{P}{R}{B \cup B_1 \cup \ddd \cup B_n}
}
...
\Inference[scope-p-con]{
  ...
  \SaysScope{\Sigma}{\Core{C}{p_1 ... p_n}}{P}{R}{B \cup B_1 \cup \ddd \cup B_n}
}
