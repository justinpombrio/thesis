...
\begin{figure}
  ...
  \TypeLabel{\SaysCase{L}{e}{e}{k}}
  \Inference[ds-expand]{
    k = \DsRuleCase{(p_1,...,p_n)}{\Gamma}{F}{p_{rhs}} \IS\\
    ...
    \SaysSubs{F}{\gamma}{p_{rhs}}{e'}
  }{
    \SaysCase{L}{\Surf{C}{c_1 ... c_n}}{\Tag{\Surf{C}{p_1' ... p_n'}}{p_{rhs}}{e'}}{k}
  }
  \caption{Expansion}
  \label{fig:expansion}
\end{figure}
