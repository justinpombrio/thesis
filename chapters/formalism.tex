...
\begin{figure}
  ...
  \Inference[ds-ctx]{
    ...
    \SaysExp{L}{E_{ds}[e]}{E_{ds}[e']}
  }
  \Inference[ds-sugar]{
    L = G,rs &
    \DsRule{C}{k_1 ... k_n} \in G \IS\\
    \SaysCase{L}{\Surf{C}{c_1 ... c_n}}{e'}{k_i}
  }{
    \SaysExp{L}{\Surf{C}{c_1 ... c_n}}{\Tag{C}{i}{e'}}
  }
  \TypeLabel{\SaysCase{L}{e}{e}{c}}
  \Inference[ds-expand]{
    \SaysMatch{L}{c_i}{p_i}{\gamma_i} \text{ for each $i$} \IS\\
    \gamma' \text{ gives fresh names to the variables in $F$} \IS\\
    \gamma_1 \DisjUnion ... \DisjUnion \gamma_n \DisjUnion \gamma' = \gamma \IS\\
    \SaysSubs{F}{\gamma}{p'}{e'}
  }{
    \SaysCase{L}{\Surf{C}{c_1 ... c_n}}{e'}{\DsRuleCase{(p_1,...,p_n)}{\Gamma}{F}{p'}}
  }
  \caption{Expansion}
  \label{fig:expansion}
\end{figure}
...
\begin{figure}
  ...
  \Inference[rs-ctx]{
    ...
    \SaysUnexp{L}{E_{rs}[e]}{E_{rs}[e']}
  }
  \Inference[rs-sugar]{
    [TODO] &
    L = G,rs &
    \DsRule{C}{k_1 ... k_n} \in G \IS\\
    \SaysUncase{L}{\Surf{C}{e_1 ... e_n}}{e'}{k_i}
  }{
    \SaysUnexp{L}{\Surf{C}{e_1 ... e_n}}{e'}
  }
  \TypeLabel{\SaysUncase{L}{e}{e}{s}}
  \Inference[rs-unexpand]{
    [TODO] &
    ...
    \SaysUncase{L}{\Surf{C}{e_1 ... e_n}}{e'}{\DsRuleCase{(p_1,...,p_n)}{\Gamma}{F}{p'}}
  }
  \caption{Unexpansion}
...
\begin{theorem}[Soundness]
  ...
  $\SaysExps{L}{e}{v}$ where $\SaysExpr{L}{v}{t}$, or $e$ runs forever.
\end{theorem}
\begin{proof}
\Cref{thm:progress} (progress) and \cref{thm:preservation}
(preservation) together imply that either:
(i) $e$ is a value, or (ii) $\SaysExp{L}{e}{e'}$ and $\SaysExpr{L}{e'}{t}$.
...
\begin{lemma}[Preservation] \label{thm:preservation}
  If $\SaysExpr{L}{e}{t}$ and $\SaysExp{L}{e}{e'}$, then $\SaysExpr{L}{e'}{t}$.
\end{lemma}
\begin{proof}
