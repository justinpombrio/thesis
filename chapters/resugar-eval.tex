...
under the titles of \emph{Resugaring: Lifting Evaluation Sequences
  ...
  Compositional Desugaring}~\cite{pombrio-resugar,pombrio-resugar-hygienic}.
...
by hygienic. In \cref{sec:rscope-eval-hygiene}, we argue that---with
some minor adjustments to the algorithms here---this scope inference
process will also make this chapter's \emph{resugaring} hygienic.
