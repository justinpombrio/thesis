...
they arise by design from the nature of syntactic sugar: the whole
\emph{point} is to give great latitude to extend a language, so of
course it can be abused; it is up to sugar authors to use sugar
responsibly.
...
\item[\Cref{chap:notation}] provides a formalism for desugaring that
