...
\end{CorrectlyIndentedCodes}\marginpar{%
  Some of the examples here were inspired by Clinger and Rees CITE.
    ...
    present taxometric purposes. % TODO: long sentence. Rewrite.
...
Software developers should not need to know this. % TODO: not clear enough
...
\Desc{Scope safe} Not Applicable
\Desc{Type safe} Not Applicable
...
different (presumably numeric) types \Code{T}: % TODO: describe pi
\begin{Codes}
template<class T>
T circular_area(T r) \{
  return pi<T> * r * r;
